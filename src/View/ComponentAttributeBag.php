...
class ComponentAttributeBag implements ArrayAccess, Htmlable, IteratorAggregate
{
    ...
    {
        $styleList = \Illuminate\Support\Arr::wrap($styleList);

        return $this->merge(['style' => \Illuminate\Support\Arr::toCssStyles($styleList)]);
    }
     ...
     *
     * @param  mixed  $value
     * @return \Bladezero\View\AppendableAttributeValue
     */
     ...
     *
     * @param  array  $attributeDefaults
     * @return \Bladezero\Support\HtmlString
     */
