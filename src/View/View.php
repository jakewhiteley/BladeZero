...
class View implements ArrayAccess, Htmlable, ViewContract
{
     ...
     *
     * @var \Bladezero\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \Bladezero\Factory  $factory
     * @param  \Bladezero\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     * @return void
     */
    public function __construct(\BladeZero\Factory $factory, Engine $engine, $view, $path, $data = [])
    {
        $this->view = $view;
        $this->path = $path;
        $this->engine = $engine;
     ...
     *
     * @param  \Bladezero\Contracts\Support\MessageProvider|array  $provider
     * @param  string  $bag
     * @return $this
     */
     ...
     *
     * @param  \Bladezero\Contracts\Support\MessageProvider|array|string  $provider
     * @return \Bladezero\Support\MessageBag
     */
