...
class DynamicComponent extends Component
{
     ...
     *
     * @var \Bladezero\View\Compilers\BladeTagCompiler
     */
     ...
     *
     * @return \Bladezero\Contracts\View\View|string
     */
    public function render()
    {
        $template = <<<'EOF'
<?php extract(collect($attributes->getAttributes())->mapWithKeys(function ($value, $key) { return [Bladezero\Support\Str::camel(str_replace([':', '.'], ' ', $key)) => $value]; })->all(), EXTR_SKIP); ?>
{{ props }}
...
EOF;
     ...
     *
     * @return \Bladezero\View\Compilers\ComponentTagCompiler
     */
    protected function compiler()
    {
        if (! static::$compiler) {
            static::$compiler = new ComponentTagCompiler(
                \Bladezero\Factory::getBladeCompilerStatic()->getClassComponentAliases(),
                \Bladezero\Factory::getBladeCompilerStatic()->getClassComponentNamespaces(),
                \Bladezero\Factory::getBladeCompilerStatic()
            );
        }
