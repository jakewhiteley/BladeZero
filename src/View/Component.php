...
abstract class Component
{
     ...
     *
     * @var \Bladezero\Contracts\View\Factory|null
     */
     ...
     * Create a Blade view with the raw component string content.
     *
     * @param  \Bladezero\Contracts\View\Factory  $factory
     * @param  string  $contents
     * @return string
     */
     ...
     * @param  \Bladezero\Contracts\Support\Arrayable|array  $data
     * @param  array  $mergeData
     * @return \Bladezero\Contracts\View\View
     */
     ...
     *
     * @return \Bladezero\Contracts\View\Factory
     */
    protected function factory()
    {
        if (is_null(static::$factory)) {
            static::$factory = \Bladezero\Factory::getInstance();
        }
