...
class SupportStringableTest extends TestCase
{
    /**
     * @param  string  $string
     * @return \Bladezero\Support\Stringable
     */
    ...
    {
        $this->assertSame('Laravel'."\n", (string) $this->stringable('Laravel')->newLine());
        $this->assertSame('foo'."\n"."\n".'bar', (string) $this->stringable('foo')->newLine(2)->append('bar'));
    }
    ...
    public function testIs()
    {
        ...
        $valueObject = new \Bladezero\Tests\Stubs\StringableObjectStub('foo/bar/baz');
        $patternObject = new \Bladezero\Tests\Stubs\StringableObjectStub('foo/*');
